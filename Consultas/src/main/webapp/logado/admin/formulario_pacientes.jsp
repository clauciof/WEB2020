...
<body>
 <nav class="navbar navbar-light bg-light justify-content-between">
		...
		<form method="post" action="${pageContext.request.contextPath}/admin/insere_paciente">
	        	<div class="form-group">
				    <label for="Paciente">Paciente</label>
				    <input type="text" class="form-control" id="paciente" aria-describedby="emailHelp" name="nome_paciente">
			  </div>
			  <div class="form-group">
