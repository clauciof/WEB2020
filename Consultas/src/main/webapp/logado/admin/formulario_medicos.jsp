...
<body>
 <nav class="navbar navbar-light bg-light justify-content-between">
		...
		<form method="post" action="${pageContext.request.contextPath}/admin/insere_medico">
	        	<div class="form-group">
				    <label for="Medico">Medico</label>
				    <input type="text" class="form-control" id="medico" aria-describedby="emailHelp" name="nome_medico">
			  </div>
			  <div class="form-group">
