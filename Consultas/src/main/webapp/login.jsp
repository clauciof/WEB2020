...
<html>
    ...
    <body>
        ...
        <div align="center"><h1><fmt:message key="auth"/></h1></div>
        <div class="container w-25 p-3">
	        ...
	        <form method="post" action="index.jsp">
			  ...
			  <div class="form-group">
			    <label for="exampleInputPassword1"><fmt:message key="senha"/></label>
			    <input type="password" class="form-control" id="exampleInputPassword1" name="senha">
			  </div>
			  <button type="submit" class="btn btn-primary" name="bOK"><fmt:message key="entrar"/></button>
	        </form>
	    </div>    
